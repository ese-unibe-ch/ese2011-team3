...
public class Security extends Secure.Security {
	...
	public static void registerUser(
			@Required(message = "Name is required") String fullname,
			@Required(message = "Nickname is required") String nickname,
			@Required(message = "e-Mail is required") String mail,
			@Required(message = "Password is required") String password,
			@Required(message = "Confirm password") String confirmPassword) {
		...
		if (!isUniqueNickname(nickname)) {
			validation.addError("nickname", "Nickname '" + nickname
					+ "' is already taken");
		}
		...
		Calendar calendar = new Calendar("default", user).save();
