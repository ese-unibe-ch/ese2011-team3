...
public class Events extends Main {
	...
	editEvent.setStart(Events.helperCreateDate(startDate, startTime,
		"HH:mm"));
	editEvent.setEnd(Events.helperCreateDate(endDate, endTime, "HH:mm"));
	editEvent.setNote(note);

	editEvent.setOccurrenceType(OccurrenceType.getType(occurrenceType));
